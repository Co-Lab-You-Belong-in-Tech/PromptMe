        ...
        <form action="#" autoComplete="on">
                <div class="flex flex-col mb-2">
                    <div class="flex relative ">
                        ...
                        <input type="text" id="sign-in-email" class=" rounded-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Name (Optional)"/>
                        </div>
                    </div>
                    <div class="flex flex-col mb-2">
                    <div class="flex relative ">

                        <input type="text" id="sign-in-email" class=" rounded-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-gray text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Email"/>
                        </div>
                    </div>
